...
public class CommandLineUtilities
{
	...
	/**
	 * This uses the apache Jakarta CLI to parse the command line. A single
	 * static instance of this class exists for global access by all parts of
	 * the program. To use this class, a list of options must be specified and
	 * passed to this method. Mandatory arguments should be encoded as strings.
	 * 
	 * @param args The command line received by main
	 * @param manditory_args A list of strings that contain the names of
	 *            mandatory arguments.
	...
	/**
	 * This method is used when there is one argument for the option presented
	 * as a ";" separated list.
	 * 
	 * @param option
